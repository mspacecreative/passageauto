(function ($) {
  ...
  // CLICK TO OPEN BIOS
  var bioContainer = $(".bio-container"),
    leahButton = $(".leah"),
    johnnaButton = $(".johnna"),
    leahBio = $("#bio-390"),
    johnnaBio = $("#bio-391");
  ...
  $(function ($) {
    ...
    if ($(".featured-product-container .display-flex > div").hasClass("col")) {
      preventDefault();
    } else {
      $(
        "<h3 style='text-align: center'>Sorry, there are currently no promotions or featured products. <br />Please check back soon!</h3>"
      ).appendTo($(".featured-product-container .display-flex"));
    }
  });
